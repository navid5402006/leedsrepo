...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .gallery-page-hero .hero-title span { color: var(--yellow); }
    .gallery-page-hero p {
    ...
    @media (max-width: 768px) {
      ...
      /* Gallery Hero */
      .gallery-page-hero { min-height: 30vh; padding-top: 60px; padding-bottom: 30px; }
      .gallery-page-hero .hero-title { font-size: clamp(1.4rem, 5vw, 1.9rem); }
      .gallery-page-hero p { font-size: .82rem; }
      ...
      .gallery-overlay .label { font-size: .7rem; }
