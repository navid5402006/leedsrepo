...
<head>
  ...
  <title>Courses – Leeds Institute</title>
  <meta name="description" content="Explore our range of academic programs at Leeds Institute including FSc Pre-Medical, Pre-Engineering, ICS, Matric, and Computer Diploma." />
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .courses-page-hero .hero-title {
      font-family: 'Playfair Display', serif;
      font-size: clamp(2rem, 5vw, 3.2rem);
      font-weight: 800; color: var(--white);
      line-height: 1.15;
    }
    .courses-page-hero .hero-title span { color: var(--yellow); }
    .courses-page-hero p {
    ...
    .course-card .card-body .info-row {
      display: flex;
      align-items: center;
      gap: 10px;
      font-size: .88rem;
    ...
    .course-card .card-body .info-row:last-child {
      border-bottom: none;
      padding-bottom: 0;
    }
    .course-card .card-body .info-row i {
      width: 20px;
      color: var(--navy);
      font-size: .9rem;
      text-align: center;
    }
    .course-card .card-body .info-row .label {
      font-weight: 500;
      color: var(--gray-400);
      min-width: 70px;
    }
    .course-card .card-body .info-row .value {
      font-weight: 600;
      color: var(--gray-800);
    }
    .course-card .card-body .info-row .value.fee {
      color: var(--red);
      font-size: 1rem;
    }
    ...
    @media (max-width: 768px) {
      ...
      /* Courses Hero */
      .courses-page-hero { min-height: 30vh; padding-top: 60px; padding-bottom: 30px; }
      .courses-page-hero .hero-title { font-size: clamp(1.4rem, 5vw, 1.9rem); }
      .courses-page-hero p { font-size: .82rem; }

      /* Courses Grid - 2 col on mobile */
      .courses-grid {
...
<div class="mobile-nav" id="mobileNav">
  ...
  <a href="courses.html" onclick="closeNav()" class="active"><i class="fas fa-book-open"></i> Courses</a>
  ...
  <div class="container">
    <div class="hero-content" data-aos="fade-up">
      <div class="section-tag" style="background:rgba(255,193,7,.15);color:var(--yellow);border:1px solid rgba(255,193,7,.2);">
        <i class="fas fa-book-open"></i> Our Programs
      </div>
      <h1 class="hero-title">Explore Our <span>Courses</span></h1>
      <p>Discover our diverse range of academic programs designed to prepare students for competitive examinations and successful professional careers.</p>
    </div>
  </div>
</section>
...
<section style="padding-top:20px;">
  <div class="container">
    <div class="courses-grid">
      ...
      <div class="course-card" data-aos="fade-up" data-aos-delay="0">
        ...
        <div class="card-body">
          ...
          <div class="info-row">
            ...
            <span class="value">Prof. Ahmed Raza</span>
          </div>
          <div class="info-row">
            <i class="fas fa-money-bill-wave"></i>
            <span class="label">Fee</span>
            <span class="value fee">Rs. 8,000/mo</span>
          </div>
        </div>
      ...
      <!-- Course 2: FSc Pre-Engineering -->
      <div class="course-card" data-aos="fade-up" data-aos-delay="80">
        ...
        <div class="card-body">
          ...
          <div class="info-row">
            <i class="fas fa-user-tie"></i>
            <span class="label">Instructor</span>
            <span class="value">Dr. Sana Malik</span>
          </div>
          <div class="info-row">
            <i class="fas fa-money-bill-wave"></i>
            <span class="label">Fee</span>
            <span class="value fee">Rs. 7,500/mo</span>
          </div>
        </div>
        <div class="card-footer">
          <a href="contact.html" class="btn btn-primary">Enroll Now</a>
      ...
      <!-- Course 3: ICS / I.Com -->
      <div class="course-card" data-aos="fade-up" data-aos-delay="160">
        <div class="card-header" style="background:linear-gradient(135deg,#065f46,#059669);">
        ...
        <div class="card-body">
          ...
          <div class="info-row">
            <i class="fas fa-user-tie"></i>
            <span class="label">Instructor</span>
            <span class="value">Mr. Usman Khan</span>
          </div>
          <div class="info-row">
            <i class="fas fa-money-bill-wave"></i>
            <span class="label">Fee</span>
            <span class="value fee">Rs. 6,500/mo</span>
          </div>
        </div>
        <div class="card-footer">
          <a href="contact.html" class="btn btn-primary">Enroll Now</a>
      ...
      <!-- Course 4: Matric (Science & Arts) -->
      <div class="course-card" data-aos="fade-up" data-aos-delay="0">
        <div class="card-header" style="background:linear-gradient(135deg,#7c2d12,#dc2626);">
          <div class="icon"><i class="fas fa-book"></i></div>
          <h3>Matric (Science & Arts)</h3>
          <span class="badge">Matriculation</span>
        </div>
        <div class="card-body">
          <div class="info-row">
            <i class="fas fa-clock"></i>
          ...
          <div class="info-row">
            <i class="fas fa-user-tie"></i>
            <span class="label">Instructor</span>
            <span class="value">Ms. Fatima Noor</span>
          </div>
          <div class="info-row">
            <i class="fas fa-money-bill-wave"></i>
            <span class="label">Fee</span>
            <span class="value fee">Rs. 5,000/mo</span>
          </div>
        </div>
        <div class="card-footer">
          <a href="contact.html" class="btn btn-primary">Enroll Now</a>
      ...
      <!-- Course 5: Computer Diploma -->
      <div class="course-card" data-aos="fade-up" data-aos-delay="80">
        <div class="card-header" style="background:linear-gradient(135deg,#312e81,#4f46e5);">
          <div class="icon"><i class="fas fa-laptop-code"></i></div>
          <h3>Computer Diploma</h3>
        ...
        <div class="card-body">
          ...
          <div class="info-row">
            <i class="fas fa-money-bill-wave"></i>
            <span class="label">Fee</span>
            <span class="value fee">Rs. 4,500/mo</span>
          </div>
        </div>
        <div class="card-footer">
          <a href="contact.html" class="btn btn-primary">Enroll Now</a>
      ...
      <!-- Course 6: Spoken English -->
      <div class="course-card" data-aos="fade-up" data-aos-delay="160">
        <div class="card-header" style="background:linear-gradient(135deg,#164e63,#0891b2);">
        ...
        <div class="card-body">
          ...
          <div class="info-row">
            <i class="fas fa-money-bill-wave"></i>
            <span class="label">Fee</span>
            <span class="value fee">Rs. 3,500/mo</span>
          </div>
        </div>
        <div class="card-footer">
          <a href="contact.html" class="btn btn-primary">Enroll Now</a>
